...
function PackagingProduct(object) {
    console.log(object);
    let [shownoteinput,updatenoteinput]=useState(0)
    let [selectboxvalue,updateselectboxvalue]=useState("")
    let [note,updatenote]=useState("Your Item is successfully Packed at himalaya Shopping ")
    ...
    async function updatePackagingstatus() {
        try {
            let response=await fetch('/updatepackagingstatus',{
                method:"POST",
                headers:{
    ...
    return (
        ...
        <div className="packagingproductsection">
            <div className="packagingproductcontainer">
                ...
                <div className="packagingproductdetails">
                    <div className="adminproduct">
                        ...
                        <div className="adminproductdetail">
                            ...
                            <p style={{ color: 'red' }}>Not Yet Packed</p>
                ...
                <div className="changepackagingstatus">
                    <select name="packagingoption" id="packagingoption" value={selectboxvalue}onChange={(event)=>{
                        ...
                        <option value="">Not Yet Packed</option>
                        <option value="Packed">Change to Packed</option>
                    </select>
                </div>
            </div>
            {
            ...
            <div className="noteentry">
                <input type="text" name="note" id="note" placeholder="Please specify the node" value={note} onChange={(event)=>{
