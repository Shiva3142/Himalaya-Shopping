...
function RecievingProduct(object) {
    ...
    async function updatebranchreachingstatus() {
        try {
            let response = await fetch('/updatehubrecievingstatus', {
                method: "POST",
                headers: {
                ...
                <div className="branchproductcontainer">
                    ...
                    <div className="branchhomeproduct">
                        <div className="adminproductdetail">
                            ...
                            <p>Sended at : <span style={{ color: 'red' }}>{getTimeDate(object.productdata.branchleftingdate)}</span></p>
                            <p>sended from : <span style={{ color: 'red' }}>{object.productdata.branchname} Branch</span></p>
                            <p>sended for : <span style={{ color: 'red' }}>{object.productdata.hubname} Hub</span></p>
                    ...
                    <div className="undopackedstatus">
                        <button onClick={updatebranchreachingstatus}>Change Status To Recieved To Hub</button>
                    </div>
                </div>
            </div>
            {/* </div> */}
