...
function RecievedProduct(object) {
    // console.log(object);
    ...
    async function updatereachingstatus() {
        try {
            let response = await fetch('/updatehubreachingstatus', {
                method: "POST",
                headers: {
        ...
        <>
            <div className="packagingproductsection">
                <div className="branchproductcontainer">
                    ...
                    <button onClick={updatereachingstatus}>Change Status To Not Recieved to Hub</button>
                </div>
                </div>
            </div>
            {/* </div> */}
